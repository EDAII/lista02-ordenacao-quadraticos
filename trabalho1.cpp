...
int main(int argc, char const *argv[]) {
  ...
  do
  {
    cout << "deseja rodar o caso de 100k itens? [s/n]" << endl;
    cin >> opt;
    opt = tolower(opt);
  ...
  if (run_100k) {
    cout << "a geração da arvore de 100.000 nós demora um pouco. Aguarde..." << endl;
